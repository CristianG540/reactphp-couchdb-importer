    ...
    */
    ...
    try {
        ...
        if(count($productos)>0){
             ...
             */
            $prodsToMod = $dbClient->post("producto_2/_all_docs", [
            ...
            // para la migracion
            $prodsToMod2 = $dbClient->post("producto_3/_all_docs", [
                //'query' => ['include_docs' => 'true'],
                'json' => [
                    'keys' => array_column($productos, '_id')
                ]
            ...
            $resImportCouch = $dbClient->post("producto_2/_bulk_docs", [
                'json' => [
                    'docs' => utf8ize($productosRev)
                ]
            ]);
            //Migracion
            $resImportCouch2 = $dbClient->post("producto_3/_bulk_docs", [
                'json' => [
